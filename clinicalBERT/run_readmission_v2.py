...
#important
from modeling_readmission_v2 import BertForSequenceClassification
...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        # logger.info("guid: %s" % (example.guid))  #K
        features.append(
...
def main():
    ...
    if args.do_train:
        ...
        string =r'./{}/pytorch_model_new_'.format(args.output_dir) + args.readmission_mode+'.bin'
